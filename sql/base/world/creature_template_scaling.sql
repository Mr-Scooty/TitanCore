...
--
-- Dumping data for table `creature_template_scaling`
--

LOCK TABLES `creature_template_scaling` WRITE;
/*!40000 ALTER TABLE `creature_template_scaling` DISABLE KEYS */;
/*!40000 ALTER TABLE `creature_template_scaling` ENABLE KEYS */;
UNLOCK TABLES;
